...
// Purpose: 
//-----------------------------------------------------------------------------
int CTFCompoundBow::TranslateViewmodelHandActivity(int iActivity)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTFCompoundBow::SetViewModel()
{
	CTFPlayer *pTFPlayer = ToTFPlayer(GetOwner());
	if (pTFPlayer == NULL)
		return;
...
const char *CTFCompoundBow::DetermineViewModelType(const char *vModel) const
{
...
// Purpose:
// -----------------------------------------------------------------------------
const char *CTFCompoundBow::GetViewModel(int iViewModel) const
{
...
//-----------------------------------------------------------------------------
C_BaseAnimating *C_TFCompoundBow::GetAppropriateWorldOrViewModel(void)
{
