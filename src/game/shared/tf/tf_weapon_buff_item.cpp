...
// Purpose: 
//-----------------------------------------------------------------------------
int CTFBuffItem::TranslateViewmodelHandActivity(int iActivity)
{
...
const char *CTFBuffItem::DetermineViewModelType(const char *vModel) const
{
...
// Purpose:
// -----------------------------------------------------------------------------
const char *CTFBuffItem::GetViewModel(int iViewModel) const
{
...
//-----------------------------------------------------------------------------
C_BaseAnimating *C_TFBuffItem::GetAppropriateWorldOrViewModel(void)
{
